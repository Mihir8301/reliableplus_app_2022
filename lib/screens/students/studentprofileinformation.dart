...
class StudentProfileInformation extends StatefulWidget {
  ...
  @override
  _StudentProfileInformationState createState() =>
      _StudentProfileInformationState();
}
...
class _StudentProfileInformationState extends State<StudentProfileInformation> {
  ...
  Widget build(BuildContext context) {
    StudentModel studentModel =
        Provider.of<UserProvider>(context, listen: true).studentModel ??
            StudentModel();
          ...
          child: Column(children: [
            ...
            Container(
                ...
                child: Column(children: [
                  ...
                  Text(
                    "Enrollment No: ${studentModel.enrollment_id}",
                    style: TextStyle(fontSize: 18, color: Colors.white),
                  ),
                  Text(
